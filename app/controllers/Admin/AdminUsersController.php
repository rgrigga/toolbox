...
class AdminUsersController extends AdminController {
     ...
     */
    public function __construct(User $user, Role $role, Permission $permission, Company $company,Project $project)
    {
        parent::__construct();
        $this->user = $user;
        $this->role = $role;
    ...
    public function getIndex()
    {
        ...
        $up=$this->user->projects();


        $userProjects=$up->paginate(5);

        $company=$this->company;
        // Show the page
        return View::make('user/index', compact('users','company','projects','userProjects'));
//            ->nest('projects','projects.index');
    }
    ...
    public function getCreate()
    {
        ...
        // Show the page
        return View::make('user/create', compact('roles', 'permissions', 'selectedRoles', 'selectedPermissions'));
    }
