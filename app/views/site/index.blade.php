...
<div id="test" class="container">
    <div class="makerow">
        ...
        <div class="side">
<!--            <button class="btn btn-xs btn-primary">run</button>-->
        </div>
    </div>
</div>
@stop
...
<div id="body-wrap2">
    ...
    <div class="welcome">
        ...
        <?php
        $arr=["I'm not sure... have we met?","Do we know each other?","You look familiar... have you been here before?"];
        ?>
        <p><?= $arr[rand(0,count($arr)-1)] ?></p>
        <p>
        </p>
        <p>
            <?= link_to_route('login','Yes',[],['class'=>'btn btn-success']) ?>
        </p>
        <p>
...
@parent
    ...
    <div id="systemstatus">
        <section class="status">
            <!--    <code>secondary</code>-->
            <div id="status" class="well text-left">
